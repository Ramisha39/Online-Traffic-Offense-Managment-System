...
<ul class="nav-links">
  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="overview-boxes">
        ...
        <div class="cardMod">
            <h4>List of Offenses </h4>
            <a href="addoffense.php" class="addDriver"> + Create </a>
        <table class="table">
  <thead>
    <tr>
      <th scope="col">#</th>
  ...
  <tbody>
    ...
    if($result->num_rows>0){
      ...
      echo "<td>".$row["name"]."</td>"; //check this
      echo "<td>".$row["code"]."</td>";
      ...
      <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
          <a class='dropdown-item' href='editoffense.php?code=".$row["code"]."'>Edit</a>
          <a class='dropdown-item' href='./controller/deleteoffense.php?id=".$row["code"]."'>Delete</a>
      </div>
  </div>
      </td>";
      echo "</tr>";

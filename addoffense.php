  ...
  <section class="home-section">
    ...
    <div class="overview-boxes" style="width:100rem;">
        <div class="box">
          ...
          <form action="./controller/addoffense.php" method="POST">
                <div class="form-group">
                    <label for="exampleInputEmail1">Date Created</label>
                    <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" name="dateCreated">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Description" name="description">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Offense Charge</label>
                    <input type="number" class="form-control" id="exampleInputPassword1" placeholder="Charge" name="rate">
                </div>
